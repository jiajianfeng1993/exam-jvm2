...
public enum ServiceBeanFactory {
    ...
    ReturnValueService returnValueService=new ReturnValueServiceImpl(skuService,inventoryService);
    /**
    ...
    public <T> T getServiceBean(Class<T> interfaceClass) {
        ...
        }else if (interfaceClass == ReturnValueService.class) {
            return (T)this.returnValueService;
        }  else {
